...
st.set_page_config(page_title="AI Powered Intelligent Decision Making System FOR BANK - V1.0", layout="wide", page_icon="🏦")
DATA_DIR = "data"
...
# --- MAIN DASHBOARD ---
st.title("🏛️ AI Powered Intelligent Decision Making System FOR BANK")
